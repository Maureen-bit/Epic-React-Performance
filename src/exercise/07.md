...
## PROFILER COMPONENT
Wrap a component tree in a <Profiler> to measure its rendering performance. Although <Profiler> is a lightweight component, it should be used only when necessary. Each use adds some CPU and memory overhead to an application.
